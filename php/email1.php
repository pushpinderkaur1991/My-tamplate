		...
		if(!isset ($_SESSION["userid"])){
			...
			if(isset($_POST['submit']))
			{
				if($_POST['email']=="")
				{
					...
					$query= "INSERT INTO email_tab(email,subject,message,userid) VALUES('" . $_POST['email'] . "', '" . $_POST["subject"] . "','" . $_POST["message"] . "','".$id."') ";
				...
				<form method="POST" style="border:1px black solid; height:590px; width:540px">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<button class="btn btn-primary"><a href="email_view1.php" target="_blank" style="color:white;font-size:13px;">VIEW EMAILS</a></button>
