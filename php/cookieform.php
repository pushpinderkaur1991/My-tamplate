        ...
        <div class="card card-container">
				...
				<img id="profile-img" class="profile-img-card" src="boot/img/login-img.png"/>
					<p id="profile-name" class="profile-name-card"></p>
						...
						<form class="form-signin" action="cookie.php" method="post">
						
							<span id="reauth-email" class="reauth-email"></span>
								<input type="email" id="emailid" name="email" class="form-control" placeholder="Email address" required autofocus>
